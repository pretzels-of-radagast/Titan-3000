...
public class SaveSystem : Singleton<SaveSystem> {
    ...
    public void AddSaveGame() {
        ...
        Slot slot = new Slot(name, GenerateSavePathName(name, false), new SaveDataContainer()); // new save very exciting :O
        if (SaveMethod == SaveType.Backup) {
            Slot backupSlot = new Slot(name, GenerateSavePathName(name, true), new SaveDataContainer()); // just a filler save.
